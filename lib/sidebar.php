...
class Roots_Sidebar {
  ...
  function __construct($conditionals = array(), $templates = array()) {
    ...
    // if (in_array(true, $conditionals) || in_array(true, $templates) || get_post_type( get_the_ID() ) === 'frames' || is_page_template( 'template-about.php' ) || is_page_template( 'template-contact.php' )) {
    //   $this->display = false;
    // }
